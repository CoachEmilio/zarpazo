      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="grid gap-4">
          {items.map((item) => (
            <details
              key={item.question}
              className="group rounded-2xl border border-zinc-900 bg-zinc-950 transition-all duration-200 hover:border-zinc-700 hover:bg-zinc-900/40 open:border-zinc-700 open:bg-zinc-900/40"
            >
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-5 font-mono text-sm font-bold text-white outline-none transition-colors group-hover:text-[#f1e6cc] group-open:text-[#f1e6cc]">
              ...
              <p className="px-5 pb-5 max-w-3xl font-mono text-sm leading-relaxed text-zinc-400">
                {item.answer}
              </p>
            </details>
          ))}
